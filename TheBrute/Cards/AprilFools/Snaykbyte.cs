...
{
    internal class Snaykbyte : AprilFoolsCard
    {
        public Snaykbyte() : base(2, CardType.Skill, CardRarity.Rare, TargetType.AnyEnemy, SpecialEventManager.IsAprilFools(DateTime.Today), SpecialEventManager.IsAprilFools(DateTime.Today))
        {
        }
