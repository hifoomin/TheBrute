...
{
    internal class SnakebiteUltra : AprilFoolsCard
    {
        public SnakebiteUltra() : base(2, CardType.Skill, CardRarity.Ancient, TargetType.AnyEnemy, SpecialEventManager.IsAprilFools(DateTime.Today), SpecialEventManager.IsAprilFools(DateTime.Today))
        {
        }
