...
{
    internal class Sneikbite : AprilFoolsCard
    {
        public Sneikbite() : base(2, CardType.Skill, CardRarity.Uncommon, TargetType.AnyEnemy, SpecialEventManager.IsAprilFools(DateTime.Today), SpecialEventManager.IsAprilFools(DateTime.Today))
        {
        }
